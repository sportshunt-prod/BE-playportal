    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "required_points",
                    models.PositiveSmallIntegerField(blank=True, default=21),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="fixture_category",
                        to="organizationApi.category",
                    ),
                ),
                (
                    "fixture_data",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="category_fixture",
                to="organizationApi.fixture",
            ),
        ),
        migrations.CreateModel(
            name="SimpleScore",
            fields=[
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        primary_key=True,
                        related_name="score_system",
                        serialize=False,
                        to="organizationApi.match",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="scheduled_matches", to="organizationApi.match"
            ),
        ),
        migrations.CreateModel(
            name="Organization",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bracket_matches",
                    models.ManyToManyField(
                        blank=True, related_name="rr_match", to="organizationApi.match"
                    ),
                ),
                (
                    "category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="rr_teams",
                        to="organizationApi.roundrobin",
                    ),
                ),
                (
                    "team",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="rr_team",
                        to="organizationApi.team",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="bracket_all_matches",
                        to="organizationApi.match",
                    ),
                ),
                (
                ...
                (
                    "bracket_teams",
                    models.ManyToManyField(
                        blank=True, related_name="bracket", to="organizationApi.team"
                    ),
                ),
                (
                    "winners_bracket",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="organizationApi.organization",
                    ),
                ),
                (
                    "sport",
